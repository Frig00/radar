...
#define MBED_CONF_BLE_TRACE_HUMAN_READABLE_ENUMS                                0                                                                                                // set by application[*]
#define MBED_CONF_BLUENRG_MS_SPI_IRQ                                            ARDUINO_UNO_A0                                                                                   // set by library:bluenrg_ms
#define MBED_CONF_BLUENRG_MS_SPI_MISO                                           ARDUINO_UNO_SPI_MISO                                                                             // set by library:bluenrg_ms
#define MBED_CONF_BLUENRG_MS_SPI_MOSI                                           ARDUINO_UNO_SPI_MOSI                                                                             // set by library:bluenrg_ms
#define MBED_CONF_BLUENRG_MS_SPI_NCS                                            ARDUINO_UNO_A1                                                                                   // set by library:bluenrg_ms
#define MBED_CONF_BLUENRG_MS_SPI_RESET                                          ARDUINO_UNO_D7                                                                                   // set by library:bluenrg_ms
#define MBED_CONF_BLUENRG_MS_SPI_SCK                                            ARDUINO_UNO_D3                                                                                   // set by library:bluenrg_ms
...
#define MBED_CONF_CORDIO_TRACE_HCI_PACKETS                                      0                                                                                                // set by application[*]
...
#define WSF_TRACE_ENABLED                                                       0                                                                                                // set by application[*]
// Macros
